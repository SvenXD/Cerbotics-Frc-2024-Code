...
public class ArmExtentionSubsystem extends SubsystemBase {
  private final ArmExtentionIO io;
  private final ArmExtentionIOInputsAutoLogged inputs;
  ...
  public ArmExtentionSubsystem(ArmExtentionIO io) {
    this.io = io;
    this.inputs = new ArmExtentionIOInputsAutoLogged();
  }
  ...
  public void periodic() {
    ...
    io.update(RobotContainer.getJointSubsystem().getAngleRadiants());
  }
