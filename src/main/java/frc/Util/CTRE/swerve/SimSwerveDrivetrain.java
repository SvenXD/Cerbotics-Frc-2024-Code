  ...
  public void update(double dtSeconds, double supplyVoltage, SwerveModule... modulesToApply) {
    ...
    for (int i = 0; i < ModuleCount; ++i) {
      ...
      steerMotor.Orientation =
          m_modules[i].SteerMotorInverted
              ? ChassisReference.Clockwise_Positive
              : ChassisReference.CounterClockwise_Positive;
      driveMotor.Orientation =
          m_modules[i].DriveMotorInverted
              ? ChassisReference.Clockwise_Positive
              : ChassisReference.CounterClockwise_Positive;
      ...
      m_modules[i].SteerMotor.setInputVoltage(
          addFriction(steerMotor.getMotorVoltage(), m_modules[i].SteerFrictionVoltage));
      m_modules[i].DriveMotor.setInputVoltage(
          addFriction(driveMotor.getMotorVoltage(), m_modules[i].DriveFrictionVoltage));
