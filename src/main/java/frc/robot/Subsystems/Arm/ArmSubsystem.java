...
public class ArmSubsystem extends SubsystemBase {
  ...
  public void periodic() {
    io.updateInputs(inputs);
    updatePID();
    SmartDashboard.putNumber("Target angle", m_controller.getSetpoint().position);
    ...
    if (enable) {
      io.setVoltage(
          m_controller.calculate(inputs.angleDegrees),
  ...
  public double getAngleRadiants() {
    return Units.degreesToRadians(inputs.angleDegrees);
  }
