...
public class SwerveModuleConstantsFactory {
    ...
    public frc.Util.CTRE.swerve.SwerveModule.ClosedLoopOutputType SteerMotorClosedLoopOutput = frc.Util.CTRE.swerve.SwerveModule.ClosedLoopOutputType.Voltage;
    /** The closed-loop output type to use for the drive motors. */
    public frc.Util.CTRE.swerve.SwerveModule.ClosedLoopOutputType DriveMotorClosedLoopOutput = frc.Util.CTRE.swerve.SwerveModule.ClosedLoopOutputType.Voltage;
     ...
     * data.
     */
    public frc.Util.CTRE.swerve.SwerveModuleConstants.SteerFeedbackType FeedbackSource = frc.Util.CTRE.swerve.SwerveModuleConstants.SteerFeedbackType.RemoteCANcoder;
