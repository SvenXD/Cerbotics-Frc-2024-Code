...
public class SwerveModuleConstantsFactory {
  ...
  public frc.Util.CTRE.swerve.SwerveModule.ClosedLoopOutputType SteerMotorClosedLoopOutput =
      frc.Util.CTRE.swerve.SwerveModule.ClosedLoopOutputType.Voltage;
  /** The closed-loop output type to use for the drive motors. */
  public frc.Util.CTRE.swerve.SwerveModule.ClosedLoopOutputType DriveMotorClosedLoopOutput =
      frc.Util.CTRE.swerve.SwerveModule.ClosedLoopOutputType.Voltage;
   ...
   */
  public frc.Util.CTRE.swerve.SwerveModuleConstants.SteerFeedbackType FeedbackSource =
      frc.Util.CTRE.swerve.SwerveModuleConstants.SteerFeedbackType.RemoteCANcoder;

  /**
   * The initial configs used to configure the drive motor of the swerve module. The default value
   * is the factory-default.
   *
   * <p>Users may change the initial configuration as they need. Any config that's not referenced in
   * the {@link SwerveModuleConstants} class is available to be changed.
   *
   * <p>The list of configs that will be overwritten is as follows:
   *
   * <ul>
   *   <li>{@link MotorOutputConfigs#NeutralMode} (Brake mode, overwritten with {@link
   *       SwerveModule#configNeutralMode(NeutralModeValue)})
   *   <li>{@link MotorOutputConfigs#Inverted} ({@link SwerveModuleConstants#DriveMotorInverted})
   ...
   *       TorqueCurrentConfigs#PeakReverseTorqueCurrent} ({@link
  ...
  /**
   * The initial configs used to configure the steer motor of the swerve module. The default value
   * is the factory-default.
   *
   * <p>Users may change the initial configuration as they need. Any config that's not referenced in
   * the {@link SwerveModuleConstants} class is available to be changed.
   ...
   *   <li>{@link MotorOutputConfigs#Inverted} ({@link SwerveModuleConstants#SteerMotorInverted})
   *   <li>{@link Slot0Configs} ({@link SwerveModuleConstants#SteerMotorGains})
   *   <li>{@link FeedbackConfigs#FeedbackRemoteSensorID} ({@link SwerveModuleConstants#CANcoderId})
   *   <li>{@link FeedbackConfigs#FeedbackSensorSource} ({@link
  ...
  /**
   * The initial configs used to configure the CANcoder of the swerve module. The default value is
   * the factory-default.
   *
   * <p>Users may change the initial configuration as they need. Any config that's not referenced in
   * the {@link SwerveModuleConstants} class is available to be changed.
   ...
   *
   * <ul>
   *   <li>{@link MagnetSensorConfigs#MagnetOffset} ({@link SwerveModuleConstants#CANcoderOffset})
   * </ul>
   */
  ...
  public SwerveModuleConstantsFactory withSteerMotorClosedLoopOutput(
      frc.Util.CTRE.swerve.SwerveModule.ClosedLoopOutputType outputType) {
  ...
  public SwerveModuleConstantsFactory withFeedbackSource(
      frc.Util.CTRE.swerve.SwerveModuleConstants.SteerFeedbackType source) {
   ...
   */
  public frc.Util.CTRE.swerve.SwerveModuleConstants createModuleConstants(
      int steerId,
      int driveId,
      int cancoderId,
    ...
    return new frc.Util.CTRE.swerve.SwerveModuleConstants()
