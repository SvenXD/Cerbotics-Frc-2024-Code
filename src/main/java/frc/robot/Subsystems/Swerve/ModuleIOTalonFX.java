...
public class ModuleIOTalonFX implements ModuleIO {
  ...
  private final double DRIVE_GEAR_RATIO = kDriveGearRatio;
  private final double TURN_GEAR_RATIO = kTurnGearRatio;
  ...
  public ModuleIOTalonFX(int index) {
    switch (index) {
      ...
      case 2:
        ...
        turnTalon = new TalonFX(kBackLeftSteerMotorId, CANBUS_STRING);
        cancoder = new CANcoder(kBackLeftEncoderId, CANBUS_STRING);
        absoluteEncoderOffset = new Rotation2d(kBackLeftEncoderOffset);
        break;
      case 3:
        driveTalon = new TalonFX(kBackRightDriveMotorId, CANBUS_STRING);
        turnTalon = new TalonFX(kBackRightSteerMotorId, CANBUS_STRING);
        cancoder = new CANcoder(kBackRightEncoderId, CANBUS_STRING);
    ...
    driveConfig.CurrentLimits.SupplyCurrentLimit = 150.0;
    driveConfig.CurrentLimits.SupplyCurrentLimitEnable = true;
    driveTalon.getConfigurator().apply(driveConfig);
    setDriveBrakeMode(true);

    var turnConfig = new TalonFXConfiguration();
    turnConfig.CurrentLimits.SupplyCurrentLimit = 50.0;
